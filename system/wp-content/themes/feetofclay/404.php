...
add_action('msdlab_title_area','msdlab_do_404_title');

function msdlab_do_404_title(){
...
add_action('genesis_after_content','msdlab_404_sitemap');

function msdlab_404_sitemap(){
