...
function msdlab_add_styles() {
    ...
    if(!is_admin()){
        //use cdn
        wp_enqueue_style('animate',get_stylesheet_directory_uri().'/lib/css/animate/animate.css',false,'4.5.0');
        wp_enqueue_style('bootstrap-style',get_stylesheet_directory_uri().'/lib/bootstrap/css/bootstrap.css',false,'4.5.0');
        //use local
        ...
        wp_enqueue_style('msd-style',get_stylesheet_directory_uri().'/lib/css/style.css',$queue,date('Ymd'));
        $queue[] = 'msd-style';
        if(is_front_page()){
            wp_enqueue_style('msd-homepage-style',get_stylesheet_directory_uri().'/lib/css/homepage.css',$queue,'20181130');
...
function msdlab_add_scripts() {
    ...
    if(!is_admin()){
        //use cdn
        wp_enqueue_script('bootstrap-jquery',get_stylesheet_directory_uri().'/lib/bootstrap/js/bootstrap.js',array('jquery'));
        //use local
